...
export async function PUT(req: Request) {
  try {
    ...
    // Fetch the pharmacy application to verify the old password
    ...
    // 1. Update to new password in pharmacy_applications
    ...
    // 2. Update to new password in pharmacy_users (Required for Login)
    ...
    if (userUpdateError) {
      console.error("Failed to update password in pharmacy_users:", userUpdateError);
