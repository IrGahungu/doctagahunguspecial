...
export async function PUT(req: Request) {
  try {
    ...
    // Fetch the insurance application to verify the old password
    ...
    // 1. Update to new password in insurance_applications
    ...
    // 2. Update to new password in insurance_users (Required for Login)
    ...
    if (userUpdateError) {
      console.error("Failed to update password in insurance_users:", userUpdateError);
